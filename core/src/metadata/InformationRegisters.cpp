...
TInformationRegisters::TInformationRegisters(v8catalog *_parent, const Utf16String& _guid)
...
TInformationRegisters::TInformationRegisters(v8catalog *_parent, const Utf16String& _guid, const Utf16String& _name)
