...
public:
    ...
    TFunctionalOptionsParameters(v8catalog* _parent, const Utf16String& _guid);
    TFunctionalOptionsParameters(v8catalog* _parent, const Utf16String& _guid, const Utf16String& _name);
    template <typename TStringLike>
    TFunctionalOptionsParameters(v8catalog* _parent, const TStringLike& _guid)
        : TFunctionalOptionsParameters(_parent, V8Utf16FromString(_guid)) {}
    template <typename TStringLikeGuid, typename TStringLikeName>
    TFunctionalOptionsParameters(v8catalog* _parent, const TStringLikeGuid& _guid, const TStringLikeName& _name)
        : TFunctionalOptionsParameters(_parent, V8Utf16FromString(_guid), V8Utf16FromString(_name)) {}
    ...
    Utf16String GetParameterName() const;
